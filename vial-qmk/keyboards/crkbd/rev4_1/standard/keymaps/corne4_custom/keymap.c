...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_LCTL, LALT_T(KC_A),  LGUI_T(KC_S),  LSFT_T(KC_D),  LCTL_T(KC_F),      KC_G,  KC_RGHT,      KC_DOWN,     KC_H,  RCTL_T(KC_J),  RSFT_T(KC_K),  RGUI_T(KC_L),  RALT_T(KC_SCLN),  KC_QUOT,
    ...
    [_NAV] = LAYOUT_split_3x6_3_ex2(
         KC_TAB,          KC_GRV,         KC_SLSH,         KC_LBRC,   KC_LPRN,  KC_LEFT,  KC_LEFT,      KC_UP,   KC_UP,         KC_7,          KC_8, KC_9, KC_BSPC,    KC_DEL,
        KC_LCTL, LALT_T(KC_BSLS), LGUI_T(KC_QUOT), LSFT_T(KC_RBRC),   KC_RPRN,  KC_RGHT,  KC_RGHT,    KC_DOWN, KC_DOWN, RCTL_T(KC_4),  RSFT_T(KC_5), KC_6,    KC_0,   KC_CAPS,
    ...
    [_FKEYS] = LAYOUT_split_3x6_3_ex2(
         KC_TAB,   KC_NO,   KC_NO, TO(_GAMING),     KC_NO, KC_PGUP,  KC_LEFT,     KC_UP,   KC_F1,         KC_F2,         KC_F3,   KC_F4,   KC_F5,    KC_DEL,
        KC_PSCR, KC_LEFT, KC_DOWN,       KC_UP,  KC_RIGHT, KC_PGDN,  KC_RGHT,   KC_DOWN,   KC_F6, RCTL_T(KC_F7), RSFT_T(KC_F8),   KC_F9,  KC_F10,   KC_CAPS,
    ...
    [_GAMING] = LAYOUT_split_3x6_3_ex2(
         KC_TAB, KC_Q,         KC_W, KC_E,    KC_R,    KC_T,  KC_LEFT,     KC_UP,   KC_1,    KC_2,          KC_3,    KC_4,         KC_5,      KC_P,
        KC_LCTL, KC_A,         KC_S, KC_D,    KC_F,    KC_G,  KC_RGHT,   KC_DOWN,   KC_H,    KC_J,          KC_K,    KC_L,         KC_I,      KC_O,
    ...
    [_SETTNGS] = LAYOUT_split_3x6_3_ex2(
        BL_TOGG, BL_STEP, BL_BRTG,   BL_ON,   BL_UP,   KC_NO,  KC_LEFT,     KC_UP,   UG_TOGG, UG_PREV,       UG_NEXT, UG_HUEU,  UG_SATU,    UG_SPDU,
          KC_NO,   KC_NO,   KC_NO,  BL_OFF, BL_DOWN,   KC_NO,  KC_RGHT,   KC_DOWN,     KC_NO, UG_VALU,       UG_VALD, UG_HUED,  UG_SATD,    UG_SPDD,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FKEYS]   = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT), ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(KC_RGHT, KC_LEFT), },
    ...
    [_SETTNGS] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT), ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(KC_RGHT, KC_LEFT), },
};
#endif
